### 📋 Checklist Studio: Block 12 (File I/O)  
...
⬜ Serializzare e deserializzare JSON (dump/load vs dumps/loads)
⬜ Importare e usare il modulo `csv`
⬜ Leggere CSV come liste (`reader`) e come dizionari (`DictReader`)
