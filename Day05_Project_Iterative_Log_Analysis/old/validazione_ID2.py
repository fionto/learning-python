...
# Creo dizionario da riempire
chiavi = ("id", "zona", "rischio", "intensita")
...
for componenti_segnale in segnali_preprocessed:
    ...
    # Se non scarto il segnale, riempio dizionario "temporaneo"
    dizionario.update({
        "id": id_int,
    ...
    # Appendo copia del dizionario temporaneo a lista dei dizionari
    segnali_processati.append(dict(dizionario))
