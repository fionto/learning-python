...
# Dati di input
spedizioni = [
    (2.5, "Italia", False, False),
    (5.0, "Germania", True, False),
    (1.2, "Francia", False, True),
    (10.0, "Italia", True, True),
    (3.0, "Spagna", False, False),
]
...
def calcola_spedizione(
        peso_kg: float, 
        destinazione: str, 
        assicurazione: bool = False, 
        spedizione_rapida: bool = False,
        ) -> float:
    """
    ...
    e il servizio di spedizione rapida.
    ...
    return COSTO_BASE + COSTO_KG * peso_kg + surplus_estero + surplus_assicurazione + surplus_rapida
...
def stampa_rapporto(
    ...
    """
    Visualizza in formato leggibile i dettagli della spedizione, inclusi
    la destinazione, il peso, i servizi aggiuntivi selezionati e il costo totale.

    Args:
        peso_kg: Peso della spedizione in chilogrammi.
        destinazione: Paese o regione di destinazione della spedizione.
        costo: Costo totale della spedizione in euro.
        assicurazione: Se True, indica che l'assicurazione è stata aggiunta.
            Defaults to False.
        spedizione_rapida: Se True, indica che la spedizione rapida è stata selezionata.
            Defaults to False.

    Returns:
        None. La funzione stampa l'output a console senza restituire valori.
    """
...
# Unpacking diretto nel for: è possibile farlo. Scoperta cosa nuova.
for peso, destinazione, assicurazione, sped_rapida in spedizioni:
    costo_totale = calcola_spedizione(peso, destinazione, assicurazione, sped_rapida)
    stampa_rapporto(peso, destinazione, costo_totale, assicurazione, sped_rapida)